...
write_xlsx(hold_out_results, "output/logsitic_regression_hold_out_stats.xlsx")

# suspausta, atrinkta duomenu aibe
hold_out_results_2d <- apply_logistic_regression_hold_out(training_set_2d, reduce = TRUE)
write_xlsx(hold_out_results_2d, "output/logistic_regression_hold_out_stats_2d.xlsx")